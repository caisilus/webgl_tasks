...
import {PlanetAttribute, instanceAttributes} from "./instance_attributes";
...
class Main {
    ...
    constructor(canvas: HTMLCanvasElement) {
        ...
        this.drawer.prepareInstanceAttributes(PlanetAttribute, instanceAttributes());
    ...
    update() {
        ...
        // this.transformator.rotateAmongAxis(performance.now() / 1000.0, [0,0,0], [0,1,0]);
